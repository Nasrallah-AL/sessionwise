...
export function generateDashboard(analysis: Analysis, relevance?: RelevanceReport): string {
  ...
  const relevanceCards = relevance
    ...
    : `<div class="empty"><strong>Relevance has not been analyzed.</strong><span>Run <code>sessionlens relevance --session &lt;id&gt;</code>.</span></div>`;
...
<meta name="description" content="SessionLens analysis of Claude Code sessions">
<link rel="icon" href="data:,">
<title>SessionLens report</title>
<style>
...
<main class="shell" id="content">
  <header class="topbar"><div class="brand">SessionLens</div><span>Claude Code report</span></header>
